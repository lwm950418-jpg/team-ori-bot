...
async function makeCard({ username, streak, total, level, xpInLevel, xpNeeded, points, rewardXp, rewardPoints }) {
  ...
  <svg width="${W}" height="${H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="700" y="82" text-anchor="middle" fill="#fff" font-family="Arial, sans-serif" font-size="56" font-weight="900" letter-spacing="8">ORI</text>
    <text x="700" y="118" text-anchor="middle" fill="#d9d9d9" font-family="Arial, sans-serif" font-size="18" letter-spacing="7">TEAM ORI  •  ATTENDANCE</text>
    ...
    <text x="270" y="350" text-anchor="middle" fill="#fff" font-family="Arial, sans-serif" font-size="92" font-weight="900" font-style="italic">ORI</text>
    <text x="270" y="455" text-anchor="middle" fill="#fff" font-family="Arial, sans-serif" font-size="30" font-weight="700">${safe}</text>
    <text x="270" y="492" text-anchor="middle" fill="#ff5a22" font-family="Arial, sans-serif" font-size="17" letter-spacing="5">TEAM ORI</text>
    <text x="270" y="566" text-anchor="middle" fill="#999" font-family="Arial, sans-serif" font-size="16">TODAY'S ATTENDANCE COMPLETE</text>

    ${panel(520,160,410,150,'🔥','연속 출석',String(streak)+'일')}
    ${panel(950,160,395,150,'📅','총 출석 횟수',String(total)+'회')}
    ...
    <text x="80" y="688" fill="#ddd" font-family="Arial, sans-serif" font-size="20">현재 XP</text>
    <rect x="220" y="670" width="660" height="24" rx="12" fill="#222428"/>
    <rect x="220" y="670" width="${660*pct}" height="24" rx="12" fill="url(#accent)"/>
    <text x="900" y="689" fill="#ff6a2b" font-family="Arial, sans-serif" font-size="20" font-weight="700">출석 보상  +${rewardXp} XP  ·  +${rewardPoints.toLocaleString()} P</text>
    <text x="700" y="748" text-anchor="middle" fill="#aaa" font-family="Arial, sans-serif" font-size="17" letter-spacing="3">내일도 출석하고 연속 보너스를 이어가세요!  •  BATTLEGROUNDS CLAN</text>
  </svg>`;
...
function panel(x,y,w,h,icon,title,value) {
  ...
  <text x="${x+28}" y="${y+54}" fill="#ff5a22" font-family="Arial, sans-serif" font-size="28" font-weight="900">${icon}</text>
  <text x="${x+82}" y="${y+48}" fill="#bbb" font-family="Arial, sans-serif" font-size="19">${title}</text>
  <text x="${x+82}" y="${y+93}" fill="#fff" font-family="Arial, sans-serif" font-size="31" font-weight="800">${value}</text>`;
}
